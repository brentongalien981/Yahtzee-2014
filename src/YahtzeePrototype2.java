...
public class YahtzeePrototype2 extends GraphicsProgram implements YahtzeeConstants {
	public static void main(String[] args) {
		new YahtzeePrototype2().start(args);
	}
	...
	private void updatePlayerScore(int player) {
		...
		// updates the score table array--NOT THE GUI
